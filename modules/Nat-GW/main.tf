...
# associate private subnet private-sub1 with private route table pri-rt-a
resource "aws_route_table_association" "private-sub1-with-pri-rt-a" {
...
# associate private subnet private-sub2 with private route pri-rt-b
